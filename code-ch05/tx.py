...
class Tx:
    ...
    def parse(cls, s, testnet=False):
        ...
        return a Tx object
        '''
        # Exercise 1: parse version only
        version = int.from_bytes(s.read(4), 'little')
        # Exercise 2: parse tx_ins
...
class TxIn:
    ...
    def parse(cls, s):
        ...
        # prev tx ID (hash of contents)
        # TBD: is it serialized in reverse byte order due to network byte order
        #   generally being little endian?
        prev_tx = s.read(32)[::-1]
